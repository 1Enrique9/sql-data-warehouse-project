...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '================================================';
        PRINT 'Carga de Plata Iniciada';
        PRINT '================================================';

		PRINT '------------------------------------------------';
		PRINT 'Cargando Tablas de CRM';
		PRINT '------------------------------------------------';
		...
		SELECT
			...
			CASE 
				WHEN UPPER(TRIM(cst_maternal_status)) = 'S' THEN 'Single'
        ...
        PRINT '>> Duración: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT '>> -------------';
		...
		PRINT '=========================================='
		PRINT 'Cargando Capa Silver Completada';
        PRINT '   - Duración Total de Carga: ' + CAST(DATEDIFF(SECOND, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' seconds';
		PRINT '=========================================='
		
	END TRY
	BEGIN CATCH
		PRINT '=========================================='
		PRINT 'ERROR EN LA CARGA DE LA CAPA SILVER'
